...
def main() -> None:
    ...
    for model in args.models:
        for label, skill, max_plies in [("Reliability", 3, 40), ("PlayQuality", 5, 60)]:
            ...
            if label == "Reliability":
                r = chess_reliability(games, max_plies=max_plies)
                score = r["chess_reliability"]
            else:
                r = compute_play_strength(games, max_plies=max_plies)
